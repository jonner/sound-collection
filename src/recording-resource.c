...
#define  SC_RECORDING_RESOURCE_GET_PRIVATE(object)(G_TYPE_INSTANCE_GET_PRIVATE((object), SC_TYPE_RECORDING_RESOURCE, ScRecordingResourcePrivate))
...
static void
sc_recording_resource_finalize (GObject *object)
{
...
static void
sc_recording_resource_set_property(GObject *obj, guint property_id, const GValue* value, GParamSpec *pspec)
{
    ...
    case PROP_COMMON_NAME:
        ...
        break;
/*    case PROP_DATE:
        self->priv->date = g_value_dup_string(value);
        break;*/
...
static void
sc_recording_resource_get_property(GObject *obj, guint property_id, GValue* value, GParamSpec *pspec)
{
    ScRecordingResource* self = SC_RECORDING_RESOURCE(obj);
...
static void
sc_recording_resource_class_init (ScRecordingResourceClass *klass)
{
    ...
    g_object_class_install_property(object_class, PROP_ID,
        g_param_spec_int64("id", NULL, NULL, -1, G_MAXINT64, -1, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_GENUS,
        g_param_spec_string("genus", NULL, NULL, NULL, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_SPECIES,
        g_param_spec_string("species", NULL, NULL, NULL, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_COMMON_NAME,
        g_param_spec_string("common-name", NULL, NULL, NULL, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_DATE,
        g_param_spec_string("date", NULL, NULL, NULL, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_SOUND_TYPE,
        g_param_spec_string("sound-type", NULL, NULL, NULL, G_PARAM_READWRITE));
    
    g_object_class_install_property(object_class, PROP_REMARKS,
        g_param_spec_string("remarks", NULL, NULL, NULL, G_PARAM_READWRITE));
}

static void
sc_recording_resource_init (ScRecordingResource *self)
{
